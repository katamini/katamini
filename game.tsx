...
const gameObjects: GameObject[] = [
  ...
  { type: 'paperclip', size: 1, model: 'models/paperclip.glb', position: [-1, 0, 2], rotation: [0, 0, 0], scale: 3, color: '#F48FB1', round: true, sound: 'music/blips/02.mp3' },
  ...
  // { type: 'paperclip', size: 3, model: 'models/paperclip.glb', position: [-3, 0, 1], rotation: [0, 0, 0], scale: 2, color: '#2196F3', round: false, sound: 'music/blips/06.mp3' },
  ...
  { type: 'trashcan', size: 12, model: 'models/trashcan.glb', position: [-6, 0, -6], rotation: [0, 0, 0], scale: 1.2, color: '#795548', sound: 'music/blips/02.mp3' },
